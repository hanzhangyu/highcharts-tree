        ...
        translate: function () {
            ...
            var drawNode = function (node) {
                ...
                var titleElement = ren
                    .label(node.item.content.title, box.x + config.node.padding.x, box.y + config.node.title.marginY + config.node.padding.y, "rect")
                    .css({
                    pointerEvents: "none",
                    fontSize: "14px",
                ...
                var tooltipElement = ren
                    .label(node.item.content.title + "<br>" + node.item.content.data.join("<br>"), box.x + box.w, box.y, "callout", undefined, undefined, true)
                    .css({
                    fontSize: "13px",
